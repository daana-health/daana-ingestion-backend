...
TARGET_SCHEMA = {
    "clinics": {
        "columns": [
            ...
            {"name": "primary_color", "type": "VARCHAR(7)", "description": "Primary brand color (hex)"},
            {"name": "secondary_color", "type": "VARCHAR(7)", "description": "Secondary brand color (hex)"},
            {"name": "logo_url", "type": "TEXT", "description": "URL to clinic logo"},
    ...
    "lots": {
        "columns": [
            ...
            {"name": "source", "type": "VARCHAR(255)", "description": "Source of the lot"},
            {"name": "note", "type": "TEXT", "description": "Additional notes about the lot"},
    ...
    "drugs": {
        "columns": [
            ...
            {"name": "generic_name", "type": "VARCHAR(255)", "description": "Generic name of medication"},
            ...
            {"name": "ndc_id", "type": "VARCHAR(50)", "description": "National Drug Code identifier"},
    ...
    "units": {
        "columns": [
            ...
            {"name": "patient_reference_id", "type": "VARCHAR(255)", "description": "Reference ID for patient"},
            ...
            {"name": "qr_code", "type": "TEXT", "description": "QR code data"},
            {"name": "optional_notes", "type": "TEXT", "description": "Optional notes"},
            {"name": "clinic_id", "type": "UUID", "description": "Foreign key to clinics"}
        ]
    },
    "transactions": {
